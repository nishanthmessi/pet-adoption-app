...
const PetProfile = () => {
  ...
  const getPostedDate = (createdDay) => {
              ...
              <div className='flex flex-col gap-6 text-6xl'>
                ...
                <div className='flex flex-col gap-4'>
                  <div className='flex items-center gap-4 font-medium'>
                    ...
                    <h1 className='text-2xl'>Neutered</h1>
                  </div>
                  <div className='flex items-center gap-4 font-medium'>
                    <p className='text-lg'>
          ...
          <div className='flex flex-col items-center gap-4'>
            ...
            <div className='flex gap-16 text-xl border-[.10rem] py-4 px-8 mt-8 rounded-md shadow-md'>
              ...
              <div className='text-center'>
                <h1 className='text-lg font-medium'>Posted on</h1>
                <p className='text-lg'>{getPostedDate(singlePet.createdAt)}</p>
              </div>
            </div>
          </div>
        </>
